...
(
    ...
    last_name character varying(23) NOT NULL,
...
CREATE TABLE public.employer_activation_by_employess
(
    id integer NOT NULL,
    employer_id integer NOT NULL,
...
ALTER TABLE public.employer_activation_by_employess
    ADD FOREIGN KEY (employer_id)
    REFERENCES public.employers (user_id)
    NOT VALID;
